...
namespace RobertsDbContextExtensions
{
    ...
    public static class DbContextExtensions
    {
        ...
        /// <param name="ctx">The DbContext to execute the SQL on</param>
        /// <param name="Sql">The SQL to be executed.</param>
        /// <param name="Parameters">A list of values to be passed as parameters. See <see href="https://github.com/rmacfadyen/RobertsDbContextExtensions/blob/master/Parameters.md">How to pass parameters</see></param>
        /// <returns></returns>
